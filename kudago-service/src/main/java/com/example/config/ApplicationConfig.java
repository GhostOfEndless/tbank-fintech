...
public class ApplicationConfig {
  ...
  public Executor asyncExecutor() {
    ...
    executor.setCorePoolSize(asyncProperties.poolSize());
    executor.setMaxPoolSize(asyncProperties.poolSize());
    executor.setQueueCapacity(asyncProperties.capacity());
  ...
  @Bean
  public Duration dataInitTerminationTimeout(@Value("${data-loading.termination-timeout:60}") long timeoutSeconds) {
    return Duration.ofSeconds(timeoutSeconds);
  }
}
